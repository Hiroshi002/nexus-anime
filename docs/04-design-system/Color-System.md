...
_\* Placeholder text at 3.2:1 is permitted per WCAG 2.2 SC 1.4.11 — placeholder is not "text that conveys information." However, we aim for 3:1 minimum even for placeholders._
