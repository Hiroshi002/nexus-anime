...
```css
--shadow-1:
  0 1px 2px 0 oklch(0.02 0.01 260 / 0.3), /* tight */ 0 1px 3px 0 oklch(0.02 0.01 260 / 0.15); /* soft */
```
...
```css
--shadow-2:
  0 2px 4px 0 oklch(0.02 0.01 260 / 0.35), /* tight */ 0 4px 8px 0 oklch(0.02 0.01 260 / 0.2); /* soft */
```
...
```css
--shadow-3:
  0 4px 6px 0 oklch(0.02 0.01 260 / 0.4), /* umbra */ 0 8px 16px 0 oklch(0.02 0.01 260 / 0.25),
  /* penumbra */ 0 2px 4px 0 oklch(0.02 0.01 260 / 0.15); /* contact */
```
...
```css
--shadow-4:
  0 8px 12px 0 oklch(0.02 0.01 260 / 0.45), /* umbra */ 0 16px 32px 0 oklch(0.02 0.01 260 / 0.3),
  /* penumbra */ 0 4px 8px 0 oklch(0.02 0.01 260 / 0.2); /* contact */
```
...
.card-primary:hover {
  box-shadow:
    ...
    0 0 16px oklch(0.6 0.15 230 / 0.2),
    /* elevation shadow layers */ 0 2px 4px 0 oklch(0.02 0.01 260 / 0.35),
...
2. **Elevation must increase monotonically** through interaction states: rest < hover < focus (or equal). Going from `elevation-2` to `elevation-0` on hover is banned — it implies the element moves _into_ the surface, which is confusing.
