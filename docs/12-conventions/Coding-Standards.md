...
Code should be readable enough to explain _what_ it does. Comments explain _why_ — the rationale a future reader cannot reconstruct from the code alone.
